...
const ActivityItem: React.FC<any> = ({ activity, isDark }) => {
    const cardBg = isDark ? 'bg-[#1F2125] hover:bg-[#25282e]' : 'bg-rose-50 hover:bg-rose-50';
...
// Default export for the /activities route
export default function Page() {
    return (
        <AppShell defaultView="Activities" activeMenu="activities">
            <ActivitiesView />
        </AppShell>
    );
}