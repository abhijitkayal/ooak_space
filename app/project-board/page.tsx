        ...
        <div className="mt-8 grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 md:col-span-4 lg:col-span-3">
            <div className={`rounded-2xl border overflow-hidden ${isDark ? "bg-[#18191d] border-gray-800" : "bg-white border-gray-200"}`}>
              <div className={`px-4 py-3 border-b font-semibold text-sm ${isDark ? "bg-[#1e1f23] border-gray-800 text-gray-100" : "bg-gray-50 border-gray-200 text-gray-900"}`}>
                Projects
              </div>
              ...
              <div className="p-2">
                ...
                {projects.length === 0 && (
                  <div className={`text-sm px-3 py-6 ${isDark ? "text-gray-500" : "text-gray-400"}`}>
                    No projects found.
                  </div>
                )}
              </div>
          ...
          <div className="col-span-12 md:col-span-8 lg:col-span-9">
            <div className={`rounded-2xl border overflow-hidden ${isDark ? "bg-[#18191d] border-gray-800" : "bg-white border-gray-200"}`}>
              <div className={`px-4 py-3 border-b flex items-center justify-between ${isDark ? "bg-[#1e1f23] border-gray-800" : "bg-gray-50 border-gray-200"}`}>
                <div>
              ...
              <div className="p-4 flex gap-4 overflow-x-auto overflow-y-hidden">
                {tabs.map((db: any) => (
                  <button
                    ...
                    className={`rounded-2xl border transition p-4 text-left shadow-sm hover:shadow-md flex-shrink-0 min-w-[250px] ${isDark ? "bg-[#1e1f23] border-gray-700 hover:bg-[#252730]" : "bg-white border-gray-200 hover:bg-gray-50"}`}
                  >
                ...
                {tabs.length === 0 && activeProjectId && (
                  <div className={`text-sm py-10 text-center w-full ${isDark ? "text-gray-500" : "text-gray-400"}`}>
                    No databases created inside this project.
                  </div>
                )}
              </div>
