                    ...
                    <div className={`relative flex items-center ${open ? "gap-3 px-4" : "justify-center px-2"} py-2 ${isActive ? "text-white" : isDark ? "text-gray-400" : "text-gray-700"}`}>
                      ...
                      {open && (
                        <div className="flex items-center justify-between w-full">
                          ...
                          <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition">
                            <button onClick={(e) => { e.stopPropagation(); item.key === "project-board" ? setCreateProjectModalOpen(true) : openCreateModal(item.key); }} className={`p-1 rounded-md ${hoverClass}`}>
                              <Plus size={16} />
                            </button>
                            <button onClick={(e) => { e.stopPropagation(); alert("Options coming soon..."); }} className={`p-1 rounded-md ${hoverClass}`}>
                              <span className="text-lg leading-none">⋯</span>
                            </button>
                          </div>
                        </div>
